...
- 🗂 **دسته‌بندی جامع دارایی** — رمزارز، سهام، ETF، صندوق، طلا، سکه، نقره، کالا (نفت/فلزات/کشاورزی)، درآمد ثابت، اوراق، ارز، املاک و مستغلات، خودرو، سرمایه‌گذاری در کسب‌وکار خصوصی، کالای کلکسیونی، نقد و سایر
...
- **ارزش‌گذاری به بهای خرید**: اگر برای یک دارایی هنوز قیمت روز ثبت نشده باشد، به‌جای صفر، به **بهای خرید** ارزش‌گذاری می‌شود تا دارایی تازه‌خریداری‌شده به‌اشتباه «زیان کامل» نشان داده نشود. به‌محض ثبت قیمت روز، ارزش و سود/زیان واقعی محاسبه می‌شود.
